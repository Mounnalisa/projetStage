            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('update.task', $task->id) }}">
                        ...
                        <!-- Collaborateur -->
                        <div class="mt-4">
                            <label for="user" class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Collaborateur') }}</label>
                            <select id="user" name="user" class="block mt-1 w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
